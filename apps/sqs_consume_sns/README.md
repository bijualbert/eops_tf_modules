# Description
An example terraform module to build simple application as aws sqs filled by sns .
...
module "sqs_app" {
  source = "git@github.com:albumprinter/eops_tf_modules.git//apps/sqs_consume_sns?ref=sqs_sns_8" # for eg. {TAG_VERSION} = v0.3.0
